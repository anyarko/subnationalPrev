...
#include "stanExports_inflated_neg_binomial_partial_pooling.h"

RCPP_MODULE(stan_fit4inflated_neg_binomial_partial_pooling_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_inflated_neg_binomial_partial_pooling")
